    ...
    var ret = this.each(function () {
      ...
      this.sumo = {
        ...
        createElems: function () {
          var O = this;
          O.E.wrap('<div class="SumoSelect"></div>');
          O.select = O.E.parent();
          O.caption = $('<span></span>');
          ...
          if (settings.outputAsCSV && O.isMulti && O.E.attr('name')) {
          ...
          if (!$('.BackdropSelect').length) {
            $('body').prepend('<div class="BackdropSelect">');
          }
        ...
        createLi: function (opt,i) {
          ...
          if (O.isMulti) {
            if ( typeof opt.context.dataset.location === 'undefined' ) {
              li.prepend('<span><i></i></span>');
            } else {
              li.children('label').addClass('anchorOption');
            }
          }

          if ( typeof opt.context.dataset.location !== 'undefined' ) {
            li.attr('data-location', opt.context.dataset.location);
          }
          ...
          if (opt.is('optgroup > option:first-child')) {
            ...
            if (opt.parent('optgroup').attr('disabled')) {
        ...
        multiSelelect: function () {
          ...
          var okbtn = $('<button class="button">OK</button>').click(function (e) {
            e.preventDefault();
        ...
        showOpts: function () {
          ...
          if (O.isMulti && (O.isFloating || settings.okCancelInMulti)) {
            O.Pstate = [];
        ...
        basicEvents: function () {
          ...
          $(win).on('resize.sumo', function () { O.floatingList(); });
        },
        ...
        onOptClick: function (li) {
          ...
          li.click(function () {
            ...
            if (!(O.isMulti && settings.triggerChangeCombined && (O.isFloating || settings.okCancelInMulti))) {
              O.setText();
              O.E.trigger('change');
            }
        ...
        isMobile: function () {
          ...
          var ua = nav.userAgent || nav.vendor || win.opera;
        ...
        floatingList: function () {
          ...
          //O.isFloating = true if window width is < specified float width
          O.isFloating = $(win).width() <= settings.floatWidth;

          //set class isFloating
          O.optDiv.toggleClass('isFloating', O.isFloating);
          ...
          O.optDiv.toggleClass('okCancelInMulti', settings.okCancelInMulti && !O.isFloating);
        },
        ...
        toggSel: function (c, i) {
          ...
          if( ! O.mob ) {
            O.optDiv.find('ul.options li:not(.optGroup)').eq(i).toggleClass('selected',c);
          }
        ...
        */
        unload: function () {
          ...
          if (settings.outputAsCSV && O.isMulti && O.select.find('input.HEMANT123').length) {
...
})(jQuery, document, navigator, window);